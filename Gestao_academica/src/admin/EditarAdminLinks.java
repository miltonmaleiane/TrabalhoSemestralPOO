...
public class EditarAdminLinks extends JDialog {

	private static EditarAdminLinks dialog;
	...
	public static void main(String[] args) {
		try {
			dialog = new EditarAdminLinks(null,null);
	 ...
	 * Create the dialog.
	 */
	public EditarAdminLinks(Admin a,AdminPrincipal am) {
		...
		JLabel lblNewLabel = new JLabel("Links das Redes Sociais ");
		lblNewLabel.setOpaque(true);
		lblNewLabel.setBackground(new Color(47, 173, 102));
		...
		JButton updatelinksbutton = new JButton("Actualizar Links");
		updatelinksbutton.setBorder(new EmptyBorder(0, 0, 0, 0));
		updatelinksbutton.setForeground(new Color(255, 255, 255));
		updatelinksbutton.setBackground(new Color(12, 69, 86));
		...
		updatelinksbutton.addActionListener(e->
		{
			...
			int result=new AdminDados().updateAdminLink(ad);
			if(result>0)
			{
