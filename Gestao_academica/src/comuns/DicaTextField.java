...
public class DicaTextField extends JTextField {  
...
/**
  ...
  public DicaTextField(String hint,Color hintforegroundcolor)
  {
	  this(hint);
	  hintlabel.setForeground(hintforegroundcolor);
  }
  public DicaTextField(String hint) {  
