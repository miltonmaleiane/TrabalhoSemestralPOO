...
public class ImprimeNotasPDF implements Printable ,ActionListener
{
	...
	public ImprimeNotasPDF(AdminPrincipal am)
	{
		this.am = am;
	}

	public ImprimeNotasPDF(DocenteMain fm) 
	{
		this.fm = fm;
	}
	public ImprimeNotasPDF(EstudanteMain sm)
	{
		this.sm=sm;
	}
   ...
   public void disposeDialog(ImprimeNotas pgd)
   {
	this.pgd=pgd;   
   }
