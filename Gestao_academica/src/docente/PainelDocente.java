...
public class PainelDocente extends JPanel implements ActionListener {
	 ...
	 * @param am 
	 */
	public PainelDocente(AdminPrincipal am)
	{
		this();
		this.am=am;
		table.addMouseListener(new MouseAdapter()
		{
			public void mousePressed(MouseEvent e)
			{
				...
				am.viewfacultypanel=new PainelVerDocente(f,am,am.facultypanel);
	...
	public PainelDocente(DocenteMain fm)
	{
		this();
		this.fm=fm;
		headinglabel.setText("Assistente(s)");
		this.addnewfaculity.setVisible(false);
		this.viewbutton.setLocation(addnewfaculity.getX(), addnewfaculity.getY());
		condition=" where courcecode='"+fm.f.getCodigoCurso()+"' and semoryear="+fm.f.getSemouano()+" and facultyid!="+fm.f.getFacultyId();
		 ...
		 table.addMouseListener(new MouseAdapter()
			{
				...
				fm.viewfacultypanel=new PainelVerDocente(f,fm,fm.facultypanel);
	 ...
	 * @param sm
	 */
	public PainelDocente(EstudanteMain sm)
	{
		this();
		this.sm=sm;
		headinglabel.setText("Docentes");
		this.addnewfaculity.setVisible(false);
		this.viewbutton.setLocation(addnewfaculity.getX(), addnewfaculity.getY());
		...
		table.addMouseListener(new MouseAdapter()
		{
			public void mousePressed(MouseEvent e)
			{
				...
				sm.viewfacultypanel=new PainelVerDocente(f,sm,sm.facultypanel);
	...
	private PainelDocente() {
		...
		headinglabel = new JLabel("Todos Docentes");
		...
		headinglabel.setOpaque(true);
		  ...
		  addnewfaculity = new JButton("Adicionar Docente");
		  addnewfaculity.setBorder(new EmptyBorder(0, 0, 0, 0));
		  addnewfaculity.setBounds(852, 139, 153, 33);
		  ...
		  viewbutton.setBounds(690, 139, 153, 33);
		  ...
		  maxphotolabel.setBounds(703, 83, 197, 33);
	...
	public void actionPerformed(ActionEvent e) {
		...
		{
			AdicionarDocente afd=new AdicionarDocente(this);
	...
	{
		ResultSet rs=new DadosDocente().getFacultyInfo(condition);
		if(rs!=null)
		{
