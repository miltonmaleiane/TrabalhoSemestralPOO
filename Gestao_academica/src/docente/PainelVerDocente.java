...
import disciplina.AtribuirDisciplina;
import estudante.EstudanteMain;


@SuppressWarnings("serial")
public class PainelVerDocente extends JPanel {
	 ...
	 */
	private PainelVerDocente(Docente f)
	{
		...
		lblDisplayingStudentDetails.setBounds(600, 11, 415, 44);
		panel.add(lblDisplayingStudentDetails);
		
		editdetailsbutton = new JButton("Actualizar Dados");
		...
		editdetailsbutton.setBounds(860, 141, 153, 35);
		...
		JLabel lblLastLogin = new JLabel("Último Acesso : ");
		if(f.getLastLogin()==null||f.getLastLogin().isEmpty())
		{
			lblLastLogin.setText("Último Acesso : No Login");
		}
		else 
		{
			lblLastLogin.setText("Último Acesso : "+f.getLastLogin());
		};;;;;;;
		...
		lblLastLogin.setBounds(650, 57, 357, 19);
		panel.add(lblLastLogin);
		
		JLabel lblStudentDetails = new JLabel("Dados do Docente");
		...
		assignsubjectbutton.setBounds(700, 141, 153, 35);
		panel.add(assignsubjectbutton);
		
		JLabel facultyidlbl = new JLabel("ID do Docente   ");
		...
		JLabel facultynamelbl = new JLabel("Nome do Docente   ");
		...
		JLabel qualificationlbl = new JLabel("Qualificação   ");
		...
		JLabel semoryearlbl = new JLabel("Semestre/Ano    ");
		...
		JLabel positionlbl = new JLabel("Tipo de Docente    ");
		...
		if(f.getCodigoCurso()==null ||f.getCodigoCurso().equals("Not Assigned"))
		{
		courcenamelabel.setText("  "+f.getCodigoCurso());	
		}
		else
		{
		courcenamelabel.setText("  "+f.getNomecurso());	
		}
		...
		{
			semoryearlabel.setText("  "+new DadosCurso().getsemoryear(f.getCodigoCurso())+"-"+f.getSemouano()+" "+" ("+f.getCodigoCurso()+")");
		}
		...
		add(profilepiclabel);
				...
				JLabel lblsemoryear = new JLabel("Experiencia   ");
	...
	public PainelVerDocente(Docente f, AdminPrincipal am,JComponent lastpanel)
	{
		// TODO Auto-generated constructor stub
		this(f);
		this.lastpanel=lastpanel;
		JLabel lblJoinedDate = new JLabel("Data de Cadastro   ");
		...
		editdetailsbutton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				...
				AdicionarDocente ad=new AdicionarDocente(am,f);
	...
	public PainelVerDocente(Docente f, DocenteMain fm, JComponent lastpanel) 
	{
		// TODO Auto-generated constructor stub
		this(f);
		this.lastpanel=lastpanel;
	...
	public PainelVerDocente(Docente f, DocenteMain fm) 
	{
		// TODO Auto-generated constructor stub
		this(f);
		assignsubjectbutton.setVisible(false);
		...
		editdetailsbutton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent arg0) {
					...
					MudarPassword cp=new MudarPassword(f);
	...
	public PainelVerDocente(Docente f, EstudanteMain sm, JComponent lastpanel)
	{
		// TODO Auto-generated constructor stub
		this(f);
		this.lastpanel=lastpanel;
