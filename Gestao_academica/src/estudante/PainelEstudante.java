...
import comuns.PainelVerFoto;
import docente.DocenteMain;
import net.proteanit.sql.DbUtils;


@SuppressWarnings("serial")
public class PainelEstudante extends JPanel implements ActionListener
{
	public JTable table;
	 ...
	 * Create the panel.
	 */
	public PainelEstudante(AdminPrincipal am)
	{
		this();
		this.am=am;
	}
	public PainelEstudante(DocenteMain fm)
	{
		this();
		this.fm=fm;
		condition=" and s.courcecode='"+fm.f.getCodigoCurso()+"' and s.semoryear="+fm.f.getSemouano()+" ";
	...
	public PainelEstudante(DocenteMain fm,JComponent lastpanel)
	{
		this();
		this.fm=fm;
		condition=" and s.courcecode='"+fm.f.getCodigoCurso()+"' and s.semoryear="+fm.f.getSemouano()+" ";
	...
	public PainelEstudante(EstudanteMain sm)
	{
		this();
		this.sm=sm;
		condition=" and s.courcecode='"+sm.s.getCodigoCurso()+"' and s.semoryear="+sm.s.getSemouano()+" "+" and userid!='"+sm.s.getIdusuario()+"'";
		this.createtablemodel();
		this.addstudentbutton.setVisible(false);
		this.viewstudentbutton.setVisible(false);
		this.viewbutton.setLocation(addstudentbutton.getX(), addstudentbutton.getY());
	...
	private PainelEstudante() 
	{
		...
		table.addMouseListener(new MouseAdapter()
		{
			public void mousePressed(MouseEvent e)
			{
				...
				Estudante s=new DadosEstudante().getStudentDetails(courcecode,sem,rollnumber);
					...
					if(am!=null)
					{
						am.viewstudentpanel=new PainelVerEstudante(s,am,am.painelEstudante);
						am.viewstudentpanel.setVisible(true);
						am.painelEstudante.setVisible(false);
					...
					{
						fm.viewstudentpanel=new PainelVerEstudante(s,fm,fm.studentpanel);
					...
					{
						sm.viewstudentpanel=new PainelVerEstudante(s,sm,sm.studentpanel);
		...
		studentslabel = new JLabel("Todos Estudantes");
		studentslabel.setIcon(null);
		studentslabel.setBounds(10, 65, 264, 44);
		panel.add(studentslabel);
		studentslabel.setBackground(new Color (47, 173, 102));
		...
		studentslabel.setOpaque(true);
		   ...
		   viewstudentbutton = new JButton("Pesquisar Estudante");
		   viewstudentbutton.setBorder(new EmptyBorder(0, 0, 0, 0));
		   viewstudentbutton.setBounds(760, 139, 153, 33);
		  ...
		  addstudentbutton.setBounds(920, 139, 153, 33);
		  ...
		  addstudentbutton.setBackground(new Color(255, 255, 255));
		   ...
		   viewbutton = new JButton("Ver/Foto");
		 viewbutton.addActionListener(this);
		  ...
		  viewbutton.setBounds(595, 139, 153, 33);
		  ...
		  maxphotospinner.setBounds(920, 98, 76, 30);
		  ...
		  maxphotolabel = new JLabel("Número de Imagens");
		  ...
		  maxphotolabel.setBounds(700, 98, 193, 30);
	...
	public void actionPerformed(ActionEvent e) 
	{
		...
		{
			VerEstudante vs=new VerEstudante(am);
			vs.setLocationRelativeTo(null);
			vs.setVisible(true);
		}
		if(e.getSource()==addstudentbutton)
		{
			AddEstudante sd=new AddEstudante(table,this);
			sd.setLocationRelativeTo(null);
			sd.setVisible(true);
			
		
		}
		if(e.getSource()==viewbutton && viewbutton.getText().equals("Ver/Foto"))
		{
		...
		else if(e.getSource()==viewbutton && viewbutton.getText().equals("Ver/Tabela"))
		{
	...
	public void createphotopanel()
	{
		...
		PainelVerFoto photoviewpanel=new PainelVerFoto(this,maxphoto);
		...
		viewbutton.setText("Ver/Tabela");
	}
	public void createtablemodel()
	{
		ResultSet rs=new DadosEstudante().getStudentinfo(condition);
		if(rs!=null)
		{
