...
public class PainelVerEstudante extends JPanel {
...
*/
	private PainelVerEstudante(Estudante s)
	{
		...
		JLabel lblDisplayingStudentDetails = new JLabel(s.getNomecompleto()+" ("+s.getIdusuario()+")");
		...
		editdetailsbutton = new JButton("Actualizar");
		...
		panel.add(editdetailsbutton);
		 ...
		 marksheetbutton = new JButton("Notas");
		...
		lblLastLogin = new JLabel("Ultimo Acesso ");
		if(s.getLastLogin()==null||s.getLastLogin().isEmpty())
		{
			lblLastLogin.setText("Last Login : Nenhum");
		}
		
		else 
		{
			lblLastLogin.setText("Ultimo Acesso  : "+s.getLastLogin());
		}
		...
		JLabel lblStudentDetails = new JLabel("Dados do Estudante");
		...
		JLabel lblContactNumber = new JLabel("Contacto ");
		...
		JLabel lblCource = new JLabel("Curso  ");
		...
		JLabel lblFatherName = new JLabel("Nome do pai  ");
		...
		JLabel lblFatherOccupation = new JLabel("Profissão  ");
		...
		JLabel lblMotherName = new JLabel("Nome da Mãe  ");
		...
		JLabel lblMotherOccupation = new JLabel("Profissão ");
		...
		JLabel rollnumberlabel = new JLabel("  "+s.getNrestudante());
		...
		JLabel studentnamelabel = new JLabel("  "+s.getNomecompleto());
		...
		JLabel courcenamelabel = new JLabel("  "+new DadosCurso().getcourcename(s.getCodigoCurso()));
		...
		JLabel fathernamelabel = new JLabel("  "+s.getNomepai());
		...
		JLabel fatheroccupationlabel = new JLabel("  "+s.getOcupacaopai());
		...
		JLabel mothernamelabel = new JLabel("  "+s.getNomemae());
		...
		JLabel motheroccupationlabel = new JLabel("  "+s.getOcupacaomae());
		...
		JLabel lblsemoryear = new JLabel("Semestre/Ano  ");
		...
		JLabel semoryearlabel = new JLabel(
				"  " + new DadosCurso().getsemoryear(s.getCodigoCurso()) + "-" + s.getSemouano() + " " + " (" + s.getCodigoCurso() + ")");
	...
	public PainelVerEstudante(Estudante s,AdminPrincipal am,JComponent lastpanel)
	{
		this(s);
		this.am=am;
		...
		marksheetbutton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				am.marksheetpanel=new PainelNotas(am,s);
		...
		backbutton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				{
					if(am.painelEstudante.viewbutton.getText().equals("Photo View"))
					{
						am.painelEstudante.createtablemodel();
					}
					else
					{
						am.painelEstudante.createphotopanel();
					}
					am.painelEstudante.setVisible(true);
				}
		...
		editdetailsbutton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent arg0) {
					...
					AddEstudante as=new AddEstudante(am,s);
	...
	public PainelVerEstudante(Estudante s,DocenteMain fm,JComponent lastpanel)
	{
		this(s);
		this.fm=fm;
		this.lastpanel=lastpanel;
		...
		marksheetbutton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				fm.marksheetpanel=new PainelNotas(fm,s);
	...
	public PainelVerEstudante(Estudante s,EstudanteMain sm,JComponent lastpanel)
	{
		this(s);
		this.sm=sm;
		this.lastpanel=lastpanel;
	...
	public PainelVerEstudante(Estudante s,EstudanteMain sm)
	{
		this(s);
		this.sm=sm;
		
		editdetailsbutton.setText("Trocar Senha");
		marksheetbutton.setVisible(false);
		...
		editdetailsbutton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent arg0) {
					...
					MudarPassword cp=new MudarPassword(s);
