...
public class VerEstudante extends JDialog implements ActionListener
{
	...
	private static VerEstudante dialog;
	/**
	 * Launch the application.
	 */
	public static void main(String[] args) {
		try {
			 dialog = new VerEstudante(null);
	 ...
	 * Create the dialog.
	 */
	public VerEstudante(AdminPrincipal am) {
		...
		JLabel headerlabel = new JLabel("Pesquisar Estudante");
		...
		panel.setLayout(null);
		 ...
		 viewdetails = new JButton("Ver Dados");
		...
		Errorlabel = new JLabel("Prenchimento Obrigatorio !");
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if(e.getSource()==semoryearcombo)
		{
			if(semoryearcombo.getSelectedIndex()>0)
			{
				String courcecode=new DadosCurso().getCourcecode(courcenamecombo.getSelectedItem()+"");
				int sem=semoryearcombo.getSelectedIndex();
				rollnumbercombo.setModel(new DefaultComboBoxModel<String>(new DadosEstudante().getRollNumber(courcecode, sem)));
			}
		}
